...
def check_reservation(user_id, reply_token):
    try:
        ...
        for eid, logs in event_map.items():
            latest_list.append(logs[-1])
...
def cancel_reservation(user_id, event_id, reply_token):
    try:
        ...
        print("cancel_reservation エラー:", e)
